...
<body>    
        <div class="tabla-scroll-x">
            ...
            <tbody>
            <tr>
                <td class="tg-yla0">MUESTREO FEO</td>
                <td class="tg-yla0"> </td>
                <td class="tg-cly1"> </td>
            ...
            <tr>
                <td class="tg-qjdd">Realización de Pruebas Cervicales NO Comparativas</td>
                <td class="tg-g4z8">Unidades de Producción</td>
                <td class="tg-nrix">1,441</td>
                <td class="tg-4bam" colspan="2">72</td>
                <td class="tg-8d8j">115</td>
            ...
            <tr>
                ...
                <td class="tg-4bam" colspan="2">108</td>
                <td class="tg-8d8j">180</td>
            ...
            <tr>
                ...
                <td class="tg-4bam" colspan="2">17</td>
                <td class="tg-3yw8">8</td>
            ...
            <tr>
                ...
                <td class="tg-4bam" colspan="2">425</td>
                <td class="tg-3yw8">254</td>
            ...
            <tr>
                ...
                <td class="tg-4bam" colspan="2">39</td>
            ...
            <tr>
                ...
                <td class="tg-4bam" colspan="2">1,030</td>
                <td class="tg-8d8j">167</td>
...
<script>
document.querySelectorAll('.sidebar-admin .nav-group-title').forEach(function(title){
    title.addEventListener('click', function(){
        const group = title.getAttribute('data-group');
        const ul = document.querySelector('.sidebar-admin .nav-group[data-group="'+group+'"]');
        if(ul){
